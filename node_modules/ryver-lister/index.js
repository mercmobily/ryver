      ...
      function makeList( listName, c, data, cb ){
        ...
        async.whilst(
          ...
          function( cb ){
            ...
            // Take care of the case where it's atthe second page number, and
            ...
            ryver.readYamlFile( ryver.getMainInfo(), filePath, '_info.yaml', function( err, info ){
              ...
              info.listerData = listerData;
              ryver.makeFileData( filePath, fileName + templateFileExt, listTemplateAsBuffer, info, function( err, fileData ){
                if( err ) return cb( err );

                ryver.log("Made fileData with:", filePath, fileName, templateFileExt, info );
